...
mod 'openstack-hyper-v/network_mgmt',        :git => "#{ssh_url}openstack-hyper-v/puppet-network_mgmt"
mod 'openstack-hyper-v/jenkins',             :git => "#{ssh_url}openstack-hyper-v/puppet-jenkins"
mod 'openstack-hyper-v/jenkins_job_builder', :git => "#{ssh_url}openstack-hyper-v/puppet-jenkins_job_builder"
##### Other modules #####
...
mod 'unaik/networkdevice',                 :git => "#{base_url}uniak/puppet-networkdevice"
